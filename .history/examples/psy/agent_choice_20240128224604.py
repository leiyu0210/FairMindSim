...
from camel.t import ModelType, RoleType


openai.api_key = "sk-HlOE7Aj8c321b2cCA638T3BlbKFJ26a72d890d54428eb5ef"
        ...
        try:
            for i in range(0, round_num):
                ...
                if model_type in [
                    ...
                    agent_3 = ChatAgent(
                        role_message, output_language="English", **(open_source_config or {})
                    )
                else:
                    agent_3 = ChatAgent(
                        role_message,
...
if __name__ == "__main__":
    ...
    run_exp(model_list, need_run=["1"], re_run=True)
