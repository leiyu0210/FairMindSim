...
def get_res(
    ...
    if model_type in [
        ...
        role = role.content + extra_prompt
        user_prompt = first_message.content
        final_res = get_glm_res(role.content, user_prompt, model_type.value)
    else:
    ...
    return (res, content, structured_dict, input_content, role, first_message)
