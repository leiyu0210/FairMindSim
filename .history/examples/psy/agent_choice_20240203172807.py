...
def get_res(
    ...
    return (res, content, structured_dict, input_content, sys_prompt, user_prompt, final_res.content)
...
def gen_character_res(
    ...
    while cha_num < len(all_chara):
        ...
        try:
            ont_res, dialog, structured_dict, input_content, sys_prompt, user_prompt, response_content = get_res(
                role_message,
                message,
                cri_agent,
                model_type,
